...
implements the [`MdKitBackendStore`](./reference/server/type-aliases/MdKitBackendStore.md) interface:
...
[API Reference](./reference/index.md) for the full backend helper API.
...
autosave-friendly policy. See [Checkpoint Policy](./reference/index/variables/CheckpointPolicy.md)
